...
public class PdfFromEmail {
  ...
  // Converts an Email (.eml) file to PDF. The JSON request uses the resource ID
  // returned after uploading the Email file.
  public static void main(String[] args) throws IOException {
    ...
    JSONObject payload = new JSONObject().put("id", inputId).put("output", "pdf_from_email");
    Request request =
        new Request.Builder()
            .url(API_URL + "/pdf")
