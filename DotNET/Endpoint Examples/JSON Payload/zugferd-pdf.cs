 ...
 * - Uploads invoice XML, then creates a ZUGFeRD / Factur-X PDF/A-3 invoice using its resource ID.
 *
 * Setup (environment):
 ...
 *
 * Usage: dotnet run -- zugferd-pdf /path/to/invoice.xml
 */
...
public static class ZugferdPdf
{
    public static async Task Execute(string[] args)
    {
        ...
        var payload = new JObject { ["id"] = xmlId, ["output"] = "zugferd_invoice", ["render_options"] = new JObject { ["locale"] = "de-DE", ["label_language"] = "de", ["font"] = "arial", ["bold_font"] = "arialbold", ["accent_color_rgb"] = new JArray(0, 92, 171) } };
